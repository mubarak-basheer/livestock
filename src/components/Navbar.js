        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style={navStyle}>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a href="/login"><button type="button" className="btn btn-info btn-sm" >Login</button></a>
                   <a href="/sign-up"><button type="button" className="btn btn-info btn-sm" >Sign up</button></a>
